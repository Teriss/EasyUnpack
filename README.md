...
- 根据文件签名识别 ZIP、RAR、7z 等格式，不迷信扩展名。
...
EasyUnpack 1.0.0 已完成核心自动解压、密码库、嵌套处理和 Windows 右键集成。它的目标不是替你研究压缩软件的全部玄学，而是把“下载完资源后的第一百零一步”变成一次右键点击。
...
当前仓库未声明开源许可证。若要在项目外分发或二次开发，请先联系仓库维护者确认授权。
